...
//testimonials
import bhaskar from '../assets/testimonials/bhaskar.jpg';
import sumeet from '../assets/testimonials/sumeet.jpg';
import ekta from '../assets/testimonials/ekta.jpg';
                    ...
                    <figure className="max-w-screen-md mx-auto">
                        ...
                        >
                            <SwiperSlide className="p-6 pb-16">
                                <div className="px-12">
                                    <blockquote>
                                        <p className="text-sm md:text-lg font-medium text-gray-800">“After looking for various options to study in Europe, I decided with the help of IKASAcademy counselors to study Masters in Business in Belgium. I am very happy, I took this decision.”</p>
                                    </blockquote>
                            ...
                            <SwiperSlide className="p-6 pb-16">
                                <div className="px-12">
                                    <blockquote>
                                        <p className="text-sm md:text-lg font-medium text-gray-800">“The Entire Education and the visa process was simplified for me with the help of systematic approch of the excellent counselors at IKASAcademy.”</p>
                                    </blockquote>
                                    <figcaption className="flex flex-col gap-4 sm:flex-row items-center sm:justify-center mt-6 space-x-3">
                            ...
                            <SwiperSlide className="p-6 pb-16">
                                <div className="px-12">
                                    <blockquote>
                                        <p className="text-sm md:text-lg font-medium text-gray-800">“IKASAcademy changed my life! I couldn't have ever imagined that I'd be studying & living in a city like Frankfurt & Berlin on my own. I'm overwhelmed with the gratitude towards Mamta Ma'am.”</p>
                                    </blockquote>
                                    <figcaption className="flex flex-col gap-4 sm:flex-row items-center sm:justify-center mt-6 space-x-3">
                            ...
                            <SwiperSlide className="p-6 pb-16">
                                <div className="px-12">
                                    <blockquote>
                                        <p className="text-sm md:text-lg font-medium text-gray-800">“I am thanful to everybody in IKASAcademy, specially for encouraging me to overcome my fears & flaws in communicating. Germany - A Dream come True for me.”</p>
                                    </blockquote>
                                    <figcaption className="flex flex-col gap-4 sm:flex-row items-center sm:justify-center mt-6 space-x-3">
