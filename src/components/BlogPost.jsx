      ...
      <main className="mt-44 mb-36 p-6 mx-auto max-w-sm sm:max-w-xl md:max-w-full lg:max-w-screen-xl">
        <div className="flex justify-between px-4 mx-auto max-w-screen-xl ">
          <article className="mx-auto w-full max-w-2xl">
              ...
              <address className="flex items-center mb-10 not-italic justify-center">
                ...
                <div className="inline-flex items-center mr-3 text-sm text-gray-900">
                  ...
                  <div>
                    ...
                    <p className="text-sm lg:text-base text-gray-600">Founder, Educator & CEO IKASAcademy</p>
            ...
            <p className='text'>Studying in Germany can be a rewarding experience, but it's essential to figure out how to manage your finances as an international student. While education in Germany is free, there are still living expenses to consider. At IKASAcademy, we understand the importance of financial planning, so here are some tips and tricks to help you finance your stay and studies in Germany.</p>
